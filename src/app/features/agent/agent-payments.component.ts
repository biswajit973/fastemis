    ...
    <div class="px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto pb-10">
      ...
      <section *ngIf="activeTab() === 'global'" class="space-y-6">
        <article class="bg-surface border border-border rounded-xl shadow-sm p-5">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
            <input [(ngModel)]="globalForm.qrImageUrl" type="text" placeholder="QR image URL" class="rounded-lg border border-border bg-surface-2 px-3 py-2 text-sm focus:outline-none focus:border-primary md:col-span-2">
      ...
      <section *ngIf="activeTab() === 'user'" class="space-y-6">
        <article class="bg-surface border border-border rounded-xl shadow-sm p-5">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
            <select [(ngModel)]="selectedUserId" class="rounded-lg border border-border bg-surface-2 px-3 py-2 text-sm focus:outline-none focus:border-primary md:col-span-2">
              <option value="">Select user</option>
              <option *ngFor="let u of userOptions()" [value]="u.id">{{ u.fullName }} ({{ u.id }})</option>
            </select>
            <input [(ngModel)]="userForm.qrImageUrl" type="text" placeholder="QR image URL" class="rounded-lg border border-border bg-surface-2 px-3 py-2 text-sm focus:outline-none focus:border-primary md:col-span-2">
            ...
            <input [(ngModel)]="userForm.validForMinutes" type="number" min="1" placeholder="Validity (minutes)" class="rounded-lg border border-border bg-surface-2 px-3 py-2 text-sm focus:outline-none focus:border-primary">
          </div>
